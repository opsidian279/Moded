-- [Modern Key System UI | Updated 2026-05-10 | By nexa | Verison 0.0.7]
...
-- Removed support for loader-provided script_key
local hui = gethui()

if getgenv().ModernLoaded and hui:FindFirstChild("ModernKeySystem") then return getgenv().Modern end
if getgenv().ModernLoaded and hui:FindFirstChild("ModernKeylessSystem") then return getgenv().Modern end
...
local function enableBlur()
    ...
    local existing = Lighting:FindFirstChild("ModernKeySystemBlur")
    if existing then existing:Destroy() end
    Internal.BlurEffect = Instance.new("BlurEffect")
    Internal.BlurEffect.Name = "ModernKeySystemBlur"
...
local function fullCleanup()
    ...
    disableBlur()
    local gui1 = hui:FindFirstChild("ModernKeySystem")
    local gui2 = hui:FindFirstChild("ModernKeylessSystem")
    local gui3 = hui:FindFirstChild("ModernLoadingScreen")
...
local function ShowLoadingScreen(onComplete)
    ...
    local oldBlur = Lighting:FindFirstChild("ModernLoadingBlur")
    if oldBlur then oldBlur:Destroy() end

    local blurEffect = Instance.new("BlurEffect")
    blurEffect.Name = "ModernLoadingBlur"
    blurEffect.Size = 0
...
function Modern:Notify(title, message, duration, iconType)
    ...
    frame.BackgroundColor3 = Modern.Theme.Header
    frame.BorderSizePixel = 0
    frame.Parent = notifGui
    Instance.new("UICorner", frame).CornerRadius = UDim.new(0, 4)

    local stroke = Instance.new("UIStroke", frame)
    stroke.Color = Modern.Theme.Accent
    stroke.Thickness = 1
    ...
    progressBar.BackgroundColor3 = Modern.Theme.Accent
    ...
    local iconMap = {
        success = {"check", Modern.Theme.Success}, error = {"alert", Modern.Theme.Error},
        warning = {"alert", Modern.Theme.Warning}, shield = {"shield", Modern.Theme.Accent},
        info = {"shield", Modern.Theme.Accent}, key = {"key", Modern.Theme.Accent},
        copy = {"copy", Modern.Theme.Success}, discord = {"discord", Modern.Theme.Discord},
        close = {"close", Modern.Theme.Error}
    }
    ...
    if iconMap[iconType] then
        ...
        icon.ImageColor3 = Modern.Theme.Text
    end
    ...
    messageLabel.TextColor3 = Modern.Theme.TextDim
